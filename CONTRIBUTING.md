Contributing to CarebitCoin Core
============================

The CarebitCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CarebitCoin Core project, and is not to be
confused with overall CarebitCoin Network Protocol consensus changes.

Whether a pull request is merged into CarebitCoin Core rests with the project merge
...
Patches that change CarebitCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the CarebitCoin consensus, it must have been
...
The project leader is the release manager for each CarebitCoin Core release.
