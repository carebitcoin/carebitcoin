...
In order to support loading of multiple wallets in carebitcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is carebitcoin.cpp.
...
Changes to carebitcoin.cpp
----------------------
carebitcoin.cpp is the entry point into carebitcoin-qt, and as such, will require some minor modifications to provide hooks for
