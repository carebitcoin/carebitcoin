...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CarebitCoin Core"),
     ...
     * override -datadir in the carebitcoin.conf file in the default data directory
     * (to be consistent with carebitcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
