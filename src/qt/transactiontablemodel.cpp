...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted CarebitCoin to zCARE");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zCARE");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received CarebitCoin from zCARE");
    case TransactionRecord::ZerocoinSpend_Change_zCARE:
        return tr("Minted Change as zCARE from zCARE Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zCARE to CarebitCoin");
