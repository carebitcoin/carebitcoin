...
public:
    ...
    void setZCarebitCoinControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzCARE_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzCARE_clicked();
    void on_pushButtonZCarebitCoinControl_clicked();
