...
/** Utility functions used by the CarebitCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render CarebitCoin addresses in monospace font
...
// Parse "carebitcoin:" URI into recipient object, return true on successful parsing
