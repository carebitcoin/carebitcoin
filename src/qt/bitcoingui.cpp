                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CarebitCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CarebitCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and carebitcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCARE"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CarebitCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about CarebitCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CarebitCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CarebitCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CarebitCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a CarebitCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CarebitCoin Core help message to get a list with possible CarebitCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CarebitCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CarebitCoin network", "", count));
}
...
{
    QString strTitle = tr("CarebitCoin Core"); // default title
...
/** Creates context menu, its actions, and carebitcoins up all the relevant signals for mouse events. */
