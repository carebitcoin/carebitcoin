...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CarebitCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "CarebitCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CarebitCoin features */
        {"carebitcoin", "masternode", &masternode, true, true, false},
        {"carebitcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"carebitcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"carebitcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"carebitcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"carebitcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"carebitcoin", "startmasternode", &startmasternode, true, true, false},
        {"carebitcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"carebitcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"carebitcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"carebitcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"carebitcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"carebitcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"carebitcoin", "mnbudget", &mnbudget, true, true, false},
        {"carebitcoin", "preparebudget", &preparebudget, true, true, false},
        {"carebitcoin", "submitbudget", &submitbudget, true, true, false},
        {"carebitcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"carebitcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"carebitcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"carebitcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"carebitcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"carebitcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"carebitcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"carebitcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"carebitcoin", "mnsync", &mnsync, true, true, false},
        {"carebitcoin", "spork", &spork, true, true, false},
        {"carebitcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"carebitcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use carebitcoind, or the -server option to carebitcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> carebitcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9293/\n";
}
