...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CarebitCoin Core carebitcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  carebitcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded carebitcoin transaction") + "\n" +
                               "  carebitcoin-tx [options] -create [commands]   " + _("Create hex-encoded carebitcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded carebitcoin transaction
