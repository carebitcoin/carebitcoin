...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/carebitcoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/carebitcoin-cli.cpp \
           src/carebitcoin-tx.cpp \
           src/carebitcoin.cpp \
           src/db.cpp \
           ...
           src/qt/carebitcoin.cpp \
           src/qt/carebitcoinstrings.cpp \
...
RESOURCES += src/qt/carebitcoin.qrc src/qt/carebitcoin_locale.qrc

TRANSLATIONS += src/qt/locale/carebitcoin_bg.ts \
                src/qt/locale/carebitcoin_de.ts \
                src/qt/locale/carebitcoin_en.ts \
                src/qt/locale/carebitcoin_es.ts \
                src/qt/locale/carebitcoin_fi.ts \
                src/qt/locale/carebitcoin_fr.ts \
                src/qt/locale/carebitcoin_it.ts \
                src/qt/locale/carebitcoin_ja.ts \
                src/qt/locale/carebitcoin_pl.ts \
                src/qt/locale/carebitcoin_pt.ts \
                src/qt/locale/carebitcoin_ru.ts \
                src/qt/locale/carebitcoin_sk.ts \
                src/qt/locale/carebitcoin_sv.ts \
                src/qt/locale/carebitcoin_vi.ts \
                src/qt/locale/carebitcoin_zh_CN.ts \
                src/qt/locale/carebitcoin_zh_TW.ts
